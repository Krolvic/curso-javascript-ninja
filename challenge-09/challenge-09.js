...
*/
console.log( 'O resultado da soma é:'+(function() {return sum;}()));
/*
Agora declare outra variáveis chamadas `subtraction`, `multiplication`,
`division` e `mod`, e atribua à elas `calculator`, passando números
diferentes para cada chamada.
*/
var subtracion = calculator(5,6)("subtracion")
var multiplication = calculator(1,6)("multiplication")
var division = calculator(4,5)("division")
var mod = calculator(7,7)("mod")
/*
...
chamada.
*/
console.log( 'O resultado da subtração é:'+subtracion);
// ?
